...
export default async function Page() {
  ...
  return (
    ...
    // </div>
    <div className="bg-[#D9D9D9] h-auto pt-[120px]">
      <form className="w-[90%] mx-auto py-4 flex flex-col justify-center items-center">
        <h3 className="md:text-[30px] text-[20px] text-[#444] my-3 font-bold">
          Contact Us
        </h3>
        <div className="md:w-[65%] w-[90%] flex flex-col justify-center items-center mx-auto">
          <div className="w-full flex flex-wrap flex-row justify-between md:my-3 my-0">
            <input
              name="fname"
              className="md:w-[48%] w-full py-4 md:my-0 my-3 px-2 bg-white text-[#6E7191] md:text-[16px] text-[14px] rounded-lg"
              type="text"
          ...
          <textarea
            name="message"
            className="w-full h-44 my-3 py-4 px-2 bg-white text-[#6E7191] md:text-[16px] text-[14px] rounded-lg"
            placeholder="Message"
            id=""
            rows="30"
            cols="10"
          ></textarea>
          <button
            className="w-auto text-[18px] my-3 font-semibold text-white py-2 border px-2 rounded-xl bg-[#0A7750] hover:bg-white hover:text-[#0A7750] hover:border-[#0A7750] transition duration-300"
            type="submit"
          >
            Submit
          </button>
