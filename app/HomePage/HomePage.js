        ...
        <div className="hero min-h-screen bg-[#EEE]">
          <div className="hero-content w-[95%] mx-auto pt-[50px] mt-[80px] flex-col  lg:flex-row">
            ...
            <div className='max-w-xl py-2 md:ml-[60px] ml-0'>
              ...
              <a href="#" type='button' className='mt-[20px] font-montserrat text-white bg-[#498240] border hover:bg-white hover:border-[#498240] hover:text-[#498240] transition duration-300 md:py-[11px] py-[8px] md:px-[24px] px-[15px] rounded-[10px]'>Read More</a>
            </div>
          </div>
        </div>
      </div>
