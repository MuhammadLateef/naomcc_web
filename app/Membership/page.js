            ...
            <div className='w-[80%] mx-auto'>
                <div class="card card-side bg-base-100 shadow-xl">
                    ...
                    <div class="w-[50%] card-body">
                        ...
                        <p>The National Association of Muslim Charitable Clinics (NAOMCC) will help your clinic/organization to connect with a wide range of benefits, including grant opportunities, networking, and other clinical support. To become an organizational member the clinic/organization must be charitable/not-for-profit and must be run or managed by Muslims.Click the button to watch on Jetflix app.</p>
