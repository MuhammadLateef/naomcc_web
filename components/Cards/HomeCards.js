...
const HomeCards = () => {
  return (
    <div className="bg-white w-full">
      <div className="w-[95%] mx-auto lg:py-4 py-5">
          <div className="w-[95%] flex-shrink-0">
            <h2 className='text-gray-700 text-2xl font-montserrat font-bold'>What We Do?</h2>
            <p className='text-black text-justify md:text-base font-montserrat'>The National Association of Muslim Charitable Clinics (NAMCC) is the only nonprofit organization whose mission is solely focused on the issues and needs of medically underserved people throughout the U.S. ( NAMCC ) programs provide a wide range of support to our members and in turn patients through funding, education and training, advocacy, standards, disaster relief, and more</p>
          </div>
