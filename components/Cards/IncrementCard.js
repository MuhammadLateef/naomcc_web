                    ...
                    <div className="flex flex-wrap justify-between items-center -m-4 text-center">
                        <div className="p-4 md:w-[19%] sm:w-1/2 w-full">
                            <div className="border-2 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                ...
                                <p className="leading-relaxed text-white text-[12px] font-bold">Treated Patients</p>
                        ...
                        <div className="p-4 md:w-[19%] sm:w-1/2 w-full">
                            ...
                            <p className="leading-relaxed text-white text-[12px] font-bold">Health Centers</p>
                                <h2 className="text-white text-[24px] font-bold">30,000</h2>
                            </div>
                        </div>
                        <div className="p-4 md:w-[19%] sm:w-1/2 w-full">
                            ...
                            <p className="leading-relaxed text-white text-[12px] font-bold">Countries</p>
                                <h2 className="text-white text-[24px] font-bold">30,000</h2>
                            </div>
                        </div>
