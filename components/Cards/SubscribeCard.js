                    ...
                    <form>
                        <div className="mx-auto max-w-4xl sm:flex sm:space-x-3 p-3 ">
                            <div className="pb-2 sm:pb-0 sm:flex-[1_0_0%]">
                                <label for="hs-hero-name-1" className="block text-sm font-medium "><span className="sr-only">Name</span></label>
                                <input type="text" id="hs-hero-name-1" className="bg-[#498240] py-3 px-4 block w-full  rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 sm:p-4 border border-white placeholder:text-white" placeholder="Name" />
                            </div>
                            <div className="pt-2 sm:pt-0 sm:pl-3 border-t border-gray-200 sm:border-t-0 sm:border-l sm:flex-[1_0_0%] bg-[#498240]">
                                <label for="hs-hero-email-1" className="block text-sm font-medium dark:text-white"><span className="sr-only">Email address</span></label>
                                <input type="email" id="hs-hero-email-1" className="bg-[#498240] border py-3 px-4 block w-full placeholder:text-white rounded-md text-sm sm:p-4" placeholder=" Email address" />
                            </div>
