        ...
        <div className='bg-[#EEE]'>
            ...
            <div className="max-w-[95%] mx-auto px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
                    ...
                    <div className="grid sm:flex sm:items-center gap-y-3 gap-x-4">
                        <Image width={300} height={100} className="rounded-lg w-20 h-20" src="/Assets/images/Home-images/team2.png" alt="Image Description" />
                    ...
                    <div className="grid sm:flex sm:items-center gap-y-3 gap-x-4">
                        <Image width={300} height={100} className="rounded-lg w-20 h-20" src="/Assets/images/Home-images/team3.png" alt="Image Description" />
