    ...
    return (
        <div className="bg-white pb-8">
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 text-gray-800 flex-wrap flex flex-col justify-center items-center">
                <div className="p-5">
                    <div className="text-lg uppercas font-medium"><a href="/">
                        <Image width={1000} height={0} className=' w-72 h-auto' src="/Assets/images/logo3.png" alt='logo' />
                    </a>
                    </div>
                ...
                <div className="p-5 flex items-center justify-center">
                    <a className='text-[40px] hover:text-green-500 text-[#4A525E]'><MdLocationOn /></a>
                      <p>11226 S. Wilcrest Dr., Houston, TX 77099 Ph: 1-281-495-7462, Ext 604</p>
                    </div>
                <ul className="flex list-none space-x-6 my-2">
                        <li><a className=' text-[40px] hover:text-green-500 text-[#4A525E]' href="#"><AiFillTwitterSquare /></a></li>
                        <li><a target='_blank' href="https://www.facebook.com/NationalAssociationofmuslimcharitableclinics" className=' text-[40px] hover:text-green-500 text-[#4A525E]'><FaFacebookSquare /></a> </li>
                        <li><a className=' text-[40px] hover:text-green-500 text-[#4A525E]' href="https://www.instagram.com/nationalassociationofmcc/"><AiFillInstagram /></a></li>
                        <li><a className=' text-[40px] hover:text-green-500 text-[#4A525E]' href="#"><AiFillLinkedin /></a></li>
                    </ul>
